...
const (
	...
	CloudBigtableV2TestProxy_TypedReadRows_FullMethodName      = "/google.bigtable.testproxy.CloudBigtableV2TestProxy/TypedReadRows"
...
type CloudBigtableV2TestProxyClient interface {
	...
	// Reads rows with the client instance using the Typed API.
	TypedReadRows(ctx context.Context, in *TypedReadRowsRequest, opts ...grpc.CallOption) (*TypedRowsResult, error)
...
func (c *cloudBigtableV2TestProxyClient) TypedReadRows(ctx context.Context, in *TypedReadRowsRequest, opts ...grpc.CallOption) (*TypedRowsResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TypedRowsResult)
	err := c.cc.Invoke(ctx, CloudBigtableV2TestProxy_TypedReadRows_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CloudBigtableV2TestProxyServer interface {
	...
	// Reads rows with the client instance using the Typed API.
	TypedReadRows(context.Context, *TypedReadRowsRequest) (*TypedRowsResult, error)
	// Writes a row with the client instance.
...
func (UnimplementedCloudBigtableV2TestProxyServer) CloseClient(context.Context, *CloseClientRequest) (*CloseClientResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CloseClient not implemented")
}
...
func (UnimplementedCloudBigtableV2TestProxyServer) TypedReadRows(context.Context, *TypedReadRowsRequest) (*TypedRowsResult, error) {
	return nil, status.Error(codes.Unimplemented, "method TypedReadRows not implemented")
}
...
func (UnimplementedCloudBigtableV2TestProxyServer) BulkMutateRows(context.Context, *MutateRowsRequest) (*MutateRowsResult, error) {
	return nil, status.Error(codes.Unimplemented, "method BulkMutateRows not implemented")
}
...
func (UnimplementedCloudBigtableV2TestProxyServer) SampleRowKeys(context.Context, *SampleRowKeysRequest) (*SampleRowKeysResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SampleRowKeys not implemented")
}
...
func RegisterCloudBigtableV2TestProxyServer(s grpc.ServiceRegistrar, srv CloudBigtableV2TestProxyServer) {
	// If the following call panics, it indicates UnimplementedCloudBigtableV2TestProxyServer was
...
func _CloudBigtableV2TestProxy_TypedReadRows_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TypedReadRowsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CloudBigtableV2TestProxyServer).TypedReadRows(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CloudBigtableV2TestProxy_TypedReadRows_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudBigtableV2TestProxyServer).TypedReadRows(ctx, req.(*TypedReadRowsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CloudBigtableV2TestProxy_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TypedReadRows",
			Handler:    _CloudBigtableV2TestProxy_TypedReadRows_Handler,
		},
		{
